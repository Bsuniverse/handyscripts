...
with tp.session.suspend():
    ...
    try:
        ...
        tpmath.compute_phaseAverage(source_zones, zones_per_timeperiod, variables_to_average, constant_variables)
